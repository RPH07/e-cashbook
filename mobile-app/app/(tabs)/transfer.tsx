...
export default function TransferScreen() {
    ...
    // logic filtering untuk transfer saja
    const filteredData = transactions
        .filter(t => {
            if (t.type !== 'transfer') return false;

            // Search (Note, Account Source, Account Destination)
            ...
            <View style={styles.headerContainer}>
                <View style={styles.searchBox}>
                    ...
                    <TextInput 
                        ...
                        placeholder="Cari transaksi transfer..."
                        value={searchQuery}
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={{ alignItems: 'center', marginTop: 50 }}>
                        ...
                        <Text style={{ color: '#888', marginTop: 10 }}>Tidak ada data transfer ditemukan</Text>
                    </View>
                }
            />
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <ScrollView>
                            ...
                            <View style={styles.dateRow}>
                                ...
                                <Text style={{fontSize: 16, marginHorizontal: 10}}>s/d</Text>
                                <TouchableOpacity style={styles.dateBtn} onPress={() => setShowPicker('end')}>
                                    <Text style={styles.dateBtnText}>
                                        {endDate ? endDate.toLocaleDateString('id-ID') : 'Akhir'}
                                    </Text>
                                </TouchableOpacity>
                            </View>
...
const styles = StyleSheet.create({
    ...
    filterBtn: {
        backgroundColor: '#1a5dab', padding: 10, borderRadius: 10
    },
    modalOverlay: {
    ...
    sectionLabel: {
        fontSize: 14, fontWeight: '600', color: '#333', marginTop: 15, marginBottom: 10
    },
    dateRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    dateBtn: {
        flex: 1, paddingVertical: 10, paddingHorizontal: 15, backgroundColor: '#f0f0f0',
        borderRadius: 8, alignItems: 'center'
    },
    dateBtnText: { fontSize: 14, color: '#333' },
    chip: {
        paddingVertical: 8, paddingHorizontal: 16, backgroundColor: '#f0f0f0', borderRadius: 20
    },
    chipActive: { backgroundColor: '#1a5dab' },
    ...
    resetBtn: {
        flex: 1, paddingVertical: 12, backgroundColor: '#eee', borderRadius: 8, alignItems: 'center'
    },
    applyBtn: {
        flex: 1, paddingVertical: 12, backgroundColor: '#1a5dab', borderRadius: 8, alignItems: 'center'
    }
});
